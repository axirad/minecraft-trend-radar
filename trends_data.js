...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 5, 3, 3], interest: [68, 59, 50, 41], rising: false,
    ...
    { name: "LankyBox", type: "Creator", subs: 42, buzz: [7, 5, 0, 0], interest: [65, 55, 20, 10], rising: false,
    ...
    { name: "TommyInnit", type: "Creator", subs: 12, buzz: [5, 5, 5, 4], interest: [49, 49, 47, 43], rising: false,
    ...
    { name: "Craftee", type: "Creator", subs: 5.2, buzz: [null, 6, 2, 2], interest: [null, 50, 35, 25], rising: false,
    ...
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9, 10], interest: [70, 77, 85, 90], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). The July 2026 newsletter delivered a sneak peek of the next AvM episode featuring Red and Blue, plus confirmation that the 'Animation vs. Geometry Dash' crossover episode is expected this month — two imminent content drops fueling fresh anticipation. 'The Machine — Animator vs. Animation 13' (Season 3, Ep. 5) released May 30 and continues pulling reaction content 7+ weeks later. Merch via alanbecker.shop and Youtooz only — zero mass-retail presence despite 33M+ subscribers: the largest under-served retail white space in creator-Minecraft merch right now." },
    ...
    { name: "Brainrot skits", type: "Format", subs: null, buzz: [7, 6, 2, 1], interest: [63, 60, 42, 30], rising: false,
    ...
    { name: "Roleplay servers", type: "Format", subs: null, buzz: [5, 5, 5, 5], interest: [46, 48, 51, 54], rising: true,
    ...
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4, 2, 2], interest: [50, 43, 28, 17], rising: false,
    ...
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 9, 9], interest: [null, null, 74, 84], rising: true,
      about: "WildBrain/Flying Bark CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix July 9, 2026. Now 6 days into streaming as of July 15 — character names remain unrevealed in wide press as of this update; fan art and reaction content building on TikTok and Shorts but specific character names not yet entering search volume. Nielsen weekly viewership numbers expected imminently. Produced under Mojang/Netflix license — monitor for character name reveals; if the show breaks out, original character names will be the next audience signal. NOT merch-eligible for Red Lava Toys." }
  ],
  ...
  headline: "WEEK OF JUL 13 — ALAN BECKER (AvM): buzz hits 10 — July newsletter confirms next AvM episode (Red & Blue sneak peek) + Animation vs Geometry Dash ep expected this month; 33.6M subs, zero mass retail = largest uncontested white space on the board. CHIP & MILO: Milo plush in stock + shipping at miloandchip.com (4K orders in 2 weeks last time, no big-box competition). CaseOh: top 1% YouTube weekly growth, 81.8M views/30 days, best open US creator slot. JJ & Mikey: week 2 Tubi/Roku streaming, Bonkers gap open until Spring 2027. OMZ active drama content; SSundee+Crainer server active; PrestonPlayz on Target+Amazon shelf. (Mojang IP: Netflix Series day 6 of streaming, character names unrevealed; Movie Summer Sale through Jul 28 — not merch.)"
};
