...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 5, 3, 3], interest: [68, 59, 50, 43], rising: false,
    ...
    { name: "LankyBox", type: "Creator", subs: 42, buzz: [7, 5, 0, 0], interest: [65, 55, 20, 12], rising: false,
    ...
    { name: "CaseOh", type: "Creator", subs: 10.65, buzz: [7, 8, 9, 9], interest: [63, 68, 76, 79], rising: true,
    ...
    { name: "Dream", type: "Creator", subs: 31.5, buzz: [5, 5, 5, 5], interest: [53, 52, 50, 48], rising: false,
    ...
    { name: "TommyInnit", type: "Creator", subs: 12, buzz: [5, 5, 5, 4], interest: [49, 49, 47, 44], rising: false,
    ...
    { name: "Wisp", type: "Creator", subs: null, buzz: [4, 4, 4, 4], interest: [46, 44, 42, 38], rising: false,
    ...
    { name: "Stampy", type: "Creator", subs: null, buzz: [4, 3, 3, 3], interest: [37, 35, 33, 30], rising: false,
    ...
    { name: "Craftee", type: "Creator", subs: 5.2, buzz: [null, 6, 2, 2], interest: [null, 50, 35, 28], rising: false,
    ...
    { name: "OMZ", type: "Creator", subs: 6.1, buzz: [null, null, 7, 7], interest: [null, null, 60, 64], rising: true,
    ...
    { name: "Chip & Milo", type: "Character/Mob", subs: 4.1, buzz: [9, 8, 9, 9], interest: [85, 83, 90, 92], rising: true,
    ...
    { name: "Brainrot skits", type: "Format", subs: null, buzz: [7, 6, 2, 1], interest: [63, 60, 42, 32], rising: false,
      about: "'Brainrot' skits are chaotic, sensory-overload short videos that use Minecraft skins to act out absurd stories. LankyBox's TikTok Shop confirmed 748K+ items sold historically — this audience converts directly to buyers at high volume. LankyBox is now confirmed quit (16+ weeks, no uploads since ~April 2026) and the format's primary signal driver is offline with no returning creator and no replacement emerging as of July 14, 2026. Format buzz at lowest point tracked." },
    { name: "Roleplay servers", type: "Format", subs: null, buzz: [5, 5, 5, 5], interest: [46, 48, 51, 53], rising: true,
    ...
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4, 2, 2], interest: [50, 43, 28, 19], rising: false,
    ...
    { name: "A Minecraft Movie", type: "Format", ip: "mojang", subs: null, buzz: [6, 7, 9, 9], interest: [62, 68, 75, 77], rising: true,
  ...
  headline: "WEEK OF JUL 13 — ALAN BECKER (AvM): 33.6M subs, The Machine wave 7+ weeks, zero mass retail = largest uncontested white space on the board. CHIP & MILO rising: Milo plush restocked at miloandchip.com (previously 4K orders in 2 weeks, zero paid marketing), 4.52% monthly sub growth, no big-box competition. CaseOh confirmed top 1% YouTube weekly growth (+100K/7 days, 4.18% engagement). JJ & Mikey Tubi/Roku streaming week 2 — Bonkers official toys gap open until Spring 2027. SSundee+Crainer server series active; PrestonPlayz at Target+Amazon. (Mojang IP: Netflix Series day 5 of streaming, character names unrevealed; Movie Summer Sale through Jul 28 — not merch.)"
};
