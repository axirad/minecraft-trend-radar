...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Aphmau", type: "Creator", subs: 25.9, buzz: [8, 9, 9, 9, 10], interest: [80, 87, 89, 89, 93], rising: true,
      about: "Aphmau (Jess) is one of the biggest kid-facing Minecraft creators (~25.9M subscribers) with 29.6B+ lifetime views as of July 2026. SDCC Jul 21: Bonkers Toys announced a brand-new MyStreet toy line at their dedicated Aphmau booth (#221) — MyStreet Collector Figure 4-Pack (Aphmau, Aaron, Zane, KC), MyStreet Mini Mystery Plush & Classic Plush (Aphmau Cat, Garroth Cat, Travis Cat), and a 17-piece Cat Cafe Surprise Set; nationwide retail August 2026. Four concurrent MeeMeows blind-box waves remain active at 9+ major retailers: Carnival Treats, Elemental MeeMeow, Celestial Cats, and MeeMeows Collectors Case — across Amazon, Walmart, Target, Claire's, GameStop, Michaels, BoxLunch, Entertainment Earth, Smyths. August = double-stacked custom merch window: existing four waves on shelf simultaneously with the MyStreet line launch — highest interest of the year." },
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 5, 3, 3, 3], interest: [68, 59, 50, 39, 34], rising: false,
    ...
    { name: "TommyInnit", type: "Creator", subs: 12, buzz: [5, 5, 5, 4, 4], interest: [49, 49, 47, 41, 38], rising: false,
    ...
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.8, buzz: [8, 8, 9, 10, 10], interest: [70, 77, 85, 98, 99], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (~33.8M subs, approaching 34M). 'Animation vs. Geometry Dash' (released July 18, 2026) is now 4 days in: professor/physicist-reacts videos are already indexed alongside gameplay and fan-edit content — the multi-niche crossover (animation + GD + science-reaction) is extending the spike's tail. GD companion level 'Wicked VIP' (Insane / 8-star, ID 143792348) built by Lunsar continues driving in-game discovery. July newsletter teases an upcoming AvM Minecraft episode featuring Red & Blue (no release date yet). Merch via alanbecker.shop and Youtooz (Couch Figures set, Blind Box) only — zero mass-retail presence despite 33M+ subscribers: largest under-served retail white space in creator-Minecraft merch." },
    ...
    { name: "Brainrot skits", type: "Format", subs: null, buzz: [7, 6, 2, 1, 1], interest: [63, 60, 42, 27, 20], rising: false,
    ...
    { name: "Roleplay servers", type: "Format", subs: null, buzz: [5, 5, 5, 5, 5], interest: [46, 48, 51, 57, 60], rising: true,
    ...
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4, 2, 2, 1], interest: [50, 43, 28, 14, 7], rising: false,
  ...
  headline: "WEEK OF JUL 20 (UPDATED JUL 22) — APHMAU SDCC: Bonkers Toys debuted the brand-new MyStreet toy line at dedicated Aphmau SDCC booth #221 (Jul 21) — MyStreet Collector Figure 4-Pack (Aphmau/Aaron/Zane/KC), Mini Mystery Plush & Classic Plush (Aphmau/Garroth/Travis Cat), 17-piece Cat Cafe Surprise Set; nationwide retail August 2026. With existing four MeeMeows blind-box waves still on shelf, August = dual-wave custom merch window, interest now 93, highest of the year. ALAN BECKER (AvM): Day 4 of 'Animation vs. Geometry Dash' reaction wave — professor/physicist-reacts videos now indexed, multi-niche (animation+GD+science) extending the spike's tail; Red & Blue AvM Minecraft episode teased in July newsletter; ~33.8M subs approaching 34M, ZERO mass retail = #1 open white-space merch slot. CaseOh: Kitty drop sold out (StarForge PC collab confirmed); +100K/week growth, next drop unannounced — best open US creator merch slot. JJ & MIKEY: TV series week 3 on Tubi/Roku, Bonkers Spring 2027 gap wide open. CHIP & MILO: Milo plush actively shipping, prev. 4K orders/2 wks, no big-box competition. SSundee+Crainer Crundee modpack updated Jul 19 (confirmed active). PrestonPlayz Bonkers Toys on Target+Amazon (live competition to benchmark). (Mojang IP: Netflix Minecraft Series 13 days in, no character names revealed, no Top 10 confirmed; Movie Summer Sale through Jul 28; Sequel filming NZ — not merch.)"
};
