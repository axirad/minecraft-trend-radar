...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "SSundee", type: "Creator", subs: 25.4, buzz: [8, 8, 8], interest: [64, 66, 68], rising: true,
    ...
    { name: "LankyBox", type: "Creator", subs: 42, buzz: [7, 5, 1], interest: [65, 55, 37], rising: false,
      about: "LankyBox is a high-energy duo with 42M subscribers known for 'brainrot'-style skits using Minecraft skins for chaotic comedy. 3+ months into a posting hiatus (no new YouTube uploads since ~April 2026) with zero return signal as of July 10, 2026; fan speculation about an Adam McArthur / Justin Kroma partnership split is now circulating on TikTok ('Why Did Justin/Adam Quit LankyBox'). TikTok Shop storefront (748,700+ items sold) remains live passively. Product line (Foxy, Boxy, Thicc Shark, Ghosty) at Target, GameStop, Amazon with no new activations. Do not re-engage until posting resumes and sustains." },
    { name: "CaseOh", type: "Creator", subs: 10.6, buzz: [7, 8, 9], interest: [63, 68, 74], rising: true,
      about: "CaseOh has grown to 10.6M YouTube subscribers and 8.54M Twitch followers. As of July 10, 2026, he is in the top 1% by weekly subscriber growth (+100K in the past 7 days, +300K in 30 days). His Casemart merchandise line is a major and growing revenue stream (~$80K–$150K/month); engagement rate 2.57% (excellent). Known for 'Minecraft BUT…' challenge and reaction content with a big comedic personality — clips spread fast on Shorts and TikTok. No official toy line exists = best open custom merch slot on the radar; audience skews slightly older (teen) but brand energy bleeds into the 8–10 demo." },
    ...
    { name: "PrestonPlayz", type: "Creator", subs: null, buzz: [7, 7, 8], interest: [62, 63, 67], rising: true,
    ...
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9], interest: [70, 77, 83], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). AvGDash (Animation vs. Geometry Dash, Hot & Cold characters) has NOT dropped yet as of July 10 — the prequel released May 29; the full episode is expected July 11 or July 18, one of the highest-anticipation drops in the creator-Minecraft calendar. New Youtooz character 'Mitsi' (grey dress, long grey hair) now has her own 9\" plush listing, expanding the collectible line. Merch via alanbecker.shop and Youtooz only — zero mass-retail presence despite 33M+ subscribers: the biggest under-served retail white space in creator-Minecraft merch." },
    ...
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 7], interest: [null, null, 62], rising: true,
      about: "WildBrain CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix June 24, 2026 — all-new original characters in a 3D action-comedy format, not publicly named ahead of launch. Produced by WildBrain (Sonic Prime, Ninjago: Dragons Rising) under Mojang license. Kids' reaction content and fan art are building on TikTok and Shorts as the show finds its audience. Mojang/Netflix IP — worth monitoring for which characters kids mention at shows, but NOT merch-eligible for Red Lava Toys." }
  ],

  // Merch-eligible names ONLY (never Mojang IP).
  movers: {
    up:   ["Alan Becker (AvM)", "JJ & Mikey", "OMZ", "Nico & Cash"],
    down: ["LankyBox", "Jelly", "Brainrot skits", "Craftee"],
    new:  []
  },

  headline: "WEEK OF JUL 6 (REFINED Jul 10) — Alan Becker AvGDash expected Jul 11 or 18: 33.6M subs, zero mass retail — biggest open custom-merch window on the radar. JJ & Mikey streaming NOW on Tubi/Roku/Ryan+ (Bonkers Toys gap until Spring 2027; Maizen's 'Carrie' + 'Banana Kid' = zero official plush). Nico & Cash: 2K+/month on Amazon, Toast Miner + Meebo undertracked. OMZ hits Walmart + new cast member coming. LankyBox: Adam/Justin split signal emerging, 3+ mo hiatus. (Mojang/WB IP: Netflix Minecraft Series live Jun 24; Summer Sale through Jul 28; Movie Squared filming NZ — not merch.)"
};
