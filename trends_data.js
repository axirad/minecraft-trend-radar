...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 5, 4], interest: [68, 59, 55], rising: false,
    ...
    { name: "PrestonPlayz", type: "Creator", subs: null, buzz: [7, 7, 8], interest: [62, 63, 65], rising: true,
    ...
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9], interest: [70, 77, 80], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). AvM Shorts Season 5 continues: the July 2026 newsletter confirmed 'AvGDash' — a new special short featuring Hot and Cold characters — dropping this month, with Ep 40 (Red & Blue duo) still to come. Active release cadence is sustaining and growing fan community engagement. These are entirely Becker's own original characters, not Mojang IP. Merch available only through alanbecker.shop and Youtooz blind boxes — zero mass-retail presence despite 33M+ subscribers: the biggest under-served retail white space in creator-Minecraft merch." },
