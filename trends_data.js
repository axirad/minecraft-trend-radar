...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9, 10], interest: [70, 77, 85, 95], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). 'Animation vs. Geometry Dash' released this week (Jul 14–17) alongside a dedicated prequel — reaction content, analysis videos, and fan art wave already underway as of July 17. A separate sneak peek of the next AvM Minecraft episode (Red & Blue) is also in queue. 'The Machine — Animator vs. Animation 13' released May 30 still pulls reaction content 7 weeks out. Merch via alanbecker.shop and Youtooz only — zero mass-retail presence despite 33M+ subscribers: largest under-served retail white space in creator-Minecraft merch right now, and a brand-new episode drop is the strongest demand catalyst on the board this week." },
    ...
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 9, 9], interest: [null, null, 74, 89], rising: true,
      about: "WildBrain/Flying Bark CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix July 9, 2026. Now day 9 of streaming as of July 17 — character names still unrevealed in wide press; fan art and reaction content continue growing on TikTok and Shorts, driving search interest higher. Nielsen first-week viewership numbers expected imminently. Produced under Mojang/Netflix license — monitor for character name reveals and Nielsen data; if the show breaks out, original character names will be the next audience signal to track. NOT merch-eligible for Red Lava Toys." }
  ],
  ...
  headline: "WEEK OF JUL 13 — ALAN BECKER (AvM): 'Animation vs. Geometry Dash' RELEASED this week (prequel + main episode both live, Jul 14–17) — reaction content and analysis wave now underway; 33.6M subs, ZERO mass retail = strongest demand catalyst + largest open custom merch white space on the board. CHIP & MILO: Milo plush actively shipping at miloandchip.com (4K orders/2 weeks last time, no big-box competition). CaseOh: top 1% YouTube growth (10.65M subs, 81.8M views/30 days), best open US creator slot. JJ & MIKEY: Tubi/Roku streaming continues week 2, Bonkers Toys retail gap open until Spring 2027. PrestonPlayz July mini figures + plush at Target/Amazon — benchmark competition on shelf. (Mojang IP: Netflix Minecraft Series day 9 of streaming, character names still unrevealed — watch for Nielsen first-week numbers; Movie Summer Sale through Jul 28 — not merch.)"
};
