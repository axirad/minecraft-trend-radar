...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Aphmau", type: "Creator", subs: 25.9, buzz: [8, 9, 9, 9, 10, 10], interest: [80, 87, 89, 89, 95, 98], rising: true,
      about: "Aphmau (Jess) is one of the biggest kid-facing Minecraft creators (~25.9M subscribers) with 29.6B+ lifetime views. Bonkers Toys debuted the new Aphmau line at SDCC 2026 (July 23–26, now closed) — products include MyStreet Classic Plushes (Aphmau Cat, Aaron Cat, Zane Cat, KC Cat), MyStreet MeeMeows Collector Figures (8 mystery cat figures), and the Cat Café Surprise Set (17-piece playset); nationwide retail launches in August 2026, now DAYS away. The MyStreet S8 theme song 'I Wouldn't Change A Thing' teaser dropped July 27; full lyric video goes public July 31. MyStreet: One Last Time (Season 8 finale) is actively returning on the Aphmau Diaries YouTube channel, driving peak fan engagement. Custom merch window is CLOSING — the gap between now and full retail saturation this August is the highest-value remaining opening of the year." },
    { name: "Maizen", type: "Creator", subs: 23, buzz: [9, 9, 9, 9, 9, 9], interest: [78, 85, 87, 88, 90, 92], rising: true,
      about: "Maizen (22.9M subs per Variety May 2026; 23B+ lifetime views, ranked #1 gaming channel globally) makes story-driven Minecraft skits built around its 'JJ and Mikey' characters. The JJ & Mikey TV series is in its sixth-plus week of streaming on Tubi, Roku, and Ryan and Friends Plus as of late July 2026. The Pocket.watch franchise deal (announced May 2026) confirms Scholastic books early 2027 and Bonkers Toys plush + blind-boxes Spring 2027 — the gap between now and the official retail toy launch remains the near-term custom-merch window." },
    ...
    { name: "Dream", type: "Creator", subs: 31.5, buzz: [5, 5, 5, 5, 5, 5], interest: [53, 52, 50, 47, 46, 41], rising: false,
    ...
    { name: "TommyInnit", type: "Creator", subs: 12, buzz: [5, 5, 5, 4, 4, 4], interest: [49, 49, 47, 41, 34, 29], rising: false,
    ...
    { name: "Wisp", type: "Creator", subs: null, buzz: [4, 4, 4, 4, 4, 4], interest: [46, 44, 42, 37, 34, 28], rising: false,
    ...
    { name: "Stampy", type: "Creator", subs: null, buzz: [4, 3, 3, 3, 3, 3], interest: [37, 35, 33, 29, 25, 18], rising: false,
    ...
    { name: "Yarik Paw", type: "Creator", subs: 4.6, buzz: [null, null, null, null, 7, 8], interest: [null, null, null, null, 57, 67], rising: true,
      about: "Yarik Paw (@YarikPawGames) is a Ukrainian creator pioneering 'cinematic Minecraft' — episodic stories with emotional arcs and cliffhangers — at ~4.6M subscribers and 2.9B lifetime views (confirmed July 2026 press). His Shorts channel (YarikPawShorts) hit 500M views in just 75 days, the fastest-growing Minecraft Shorts signal on the board. Buzz elevated to 8 as press coverage and search interest accelerate heading into August. The narrative format with recurring characters maps well to the 5–10 demo (comparable to Aphmau-style story-Minecraft). No toy or licensing deal found as of late July 2026 — notable white space given the defined character roster and the proven appetite for story-Minecraft product." },
    ...
    { name: "Brainrot skits", type: "Format", subs: null, buzz: [7, 6, 2, 1, 1, 1], interest: [63, 60, 42, 27, 16, 9], rising: false,
      about: "'Brainrot' skits are chaotic, sensory-overload short videos that use Minecraft skins to act out absurd stories. LankyBox's TikTok Shop confirmed 748K+ items sold historically — this audience converts directly to buyers at high volume. LankyBox is now confirmed quit (26+ weeks, no uploads since ~April 2026) and the format's primary signal driver is offline with no returning creator and no replacement emerging as of late July 2026. Format interest at lowest point tracked." },
    { name: "Roleplay servers", type: "Format", subs: null, buzz: [5, 5, 5, 5, 6, 6], interest: [46, 48, 51, 57, 64, 70], rising: true,
      about: "Minecraft roleplay (RP) servers are fictional worlds with their own economies, governments and ongoing storylines where players act out characters. They're growing fast as a social, narrative way to play. OMZ Crew's 'Crystal's EX BOYFRIEND Joins the Omz Crew' storyline is the active engagement driver into late July 2026, pushing interest to 70. Popular with kids who love the 'pretend' and community side." },

    // ---- MOJANG IP — official game content (CUSTOMER AWARENESS ONLY, not merch) ----
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4, 2, 2, 1, 0], interest: [50, 43, 28, 14, 5, 2], rising: false,
    ...
    { name: "A Minecraft Movie", type: "Format", ip: "mojang", subs: null, buzz: [6, 7, 9, 9, 9, 9], interest: [62, 68, 75, 77, 78, 72], rising: false,
    ...
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 9, 9, 9, 8], interest: [null, null, 74, 89, 86, 76], rising: false,
      about: "WildBrain/Flying Bark CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) is in its seventh week of streaming on Netflix as of late July 2026. No character names revealed in wide press and no Netflix Top 10 appearance confirmed after 6+ weeks — moderate rather than breakout reception now confirmed. Fan art and reaction content continue at lower velocity. Produced under Mojang/Netflix license — monitor for character name reveals and first Top 10 chart appearance; those milestones will signal when mainstream demand peaks. NOT merch-eligible for Red Lava Toys." }
  ],
  ...
  headline: "WEEK OF JUL 27 — APHMAU: MyStreet S8 theme song teaser live Jul 27; lyric video drops Jul 31; Bonkers nationwide retail arrives in DAYS (August 2026) — custom window is CLOSING, sell before retail saturates. ALAN BECKER (AvM): AVM Shorts Ep 40 (Red & Blue) anticipated August; anticipation building post-AvG (Jul 18); 33.6M subs, ZERO mass retail = #1 white-space merch slot. YARIK PAW: buzz up to 8 — 2.9B lifetime views confirmed press, Shorts 500M in 75 days, no toy deal = open white space; interest rising to 67. JJ & MIKEY: TV series week 6+ on Tubi/Roku/Ryan Friends Plus; Bonkers+Scholastic Spring 2027 = custom gap wide open NOW. CHIP & MILO: Milo plush confirmed shipping; interest 96; DTC/Amazon only — no big-box competition. SSundee+Crainer: Crundee modpack updated Jul 19, active; interest 83. OMZ: Crystal storyline sustaining roleplay format; interest 70, rising. (Mojang IP context: Minecraft Summer Sale ended Jul 28; Netflix Series week 7 — no Top 10 or character reveals after 6+ weeks, interest settling at 76, moderate reception confirmed — not merch; Movie sequel filming NZ for Jul 2027 — not merch.)"
};
