...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 6], interest: [68, 64], rising: false,
      about: "Jelly is a top kid-friendly Minecraft YouTuber (~23M subs) known for short, easy-to-watch videos. He plays challenges, mini-games and modded worlds, often with friends. Interest has softened further into July 2026 with no standout new hook content driving search." },
    ...
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4], interest: [50, 46], rising: false,
    ...
    { name: "A Minecraft Movie", type: "Format", ip: "mojang", subs: null, buzz: [6, 7], interest: [62, 66], rising: true,
      about: "The live-action/animated Warner Bros. film (April 2025) continues to drive streaming discovery in summer 2026. Sequel 'A Minecraft Movie Squared' confirmed for July 23, 2027 (announced Minecraft Live May 30, 2026): full original cast (Momoa, Black, Brooks, Berry, Coolidge) returning, Kirsten Dunst newly added, filming underway in New Zealand, and a Minecraft Build Challenge invites fans to submit creations for possible inclusion on-screen. Mojang/WB IP — strong customer-conversation context, not merch-eligible for Red Lava Toys." }
  ],
