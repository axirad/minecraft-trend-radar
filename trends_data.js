...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Mikecrack", type: "Creator", subs: 58.6, buzz: [7, 7, 7, 7], interest: [72, 71, 71, 71], rising: false,
    ...
    { name: "SSundee", type: "Creator", subs: 25.45, buzz: [8, 8, 9, 9], interest: [64, 66, 72, 76], rising: true,
    ...
    { name: "CaseOh", type: "Creator", subs: 10.75, buzz: [7, 8, 9, 9], interest: [63, 68, 76, 82], rising: true,
      about: "CaseOh has grown to ~10.75M YouTube subscribers. As of July 19, 2026, monthly growth rate is +2.07% with 5.29% engagement (rated Very Good by HypeAuditor). A CaseOh Kitty merch drop launched July 3, 2026 (hoodies, apparel, PC accessories at caseohgames.com). Known for 'Minecraft BUT…' challenge and reaction content. No official toy line exists = best open custom merch slot with CaseOh's continuing trajectory; audience skews slightly older (teen) but brand energy bleeds into the 8–10 demo." },
    ...
    { name: "OMZ", type: "Creator", subs: 6.06, buzz: [null, null, 7, 7], interest: [null, null, 60, 68], rising: true,
    ...
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9, 10], interest: [70, 77, 85, 98], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). 'Animation vs. Geometry Dash' released July 18, 2026 — the seventh installment in the series, with a dedicated in-game Geometry Dash level (Wicked VIP, Insane / 8-star) tied to the video. Reaction content, analysis videos, and fan art wave ramping from July 19 onward; view count spike expected this week. July newsletter also teases next AvM Minecraft episode (Red & Blue) with no release date yet. Merch via alanbecker.shop and Youtooz only — zero mass-retail presence despite 33M+ subscribers: largest under-served retail white space in creator-Minecraft merch right now." },
    ...
    { name: "A Minecraft Movie", type: "Format", ip: "mojang", subs: null, buzz: [6, 7, 9, 9], interest: [62, 68, 75, 77], rising: true,
      about: "The live-action/animated Warner Bros. film (April 2025) continues to drive streaming discovery; the Minecraft Summer Sale (June 30–July 28, 2026) runs through end of July — doorbuster deals (75% off) expired July 14, main sale continues. Sequel 'A Minecraft Movie Squared' (July 23, 2027) filming in New Zealand — confirmed cast includes Momoa, Black, Brooks, Myers, Hansen, Coolidge returning, plus Kirsten Dunst as Alex; Matt Berry in a mystery role (fan speculation: Herobrine). Mojang/WB IP — strong customer-conversation context, not merch-eligible for Red Lava Toys." },
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 9, 9], interest: [null, null, 74, 89], rising: true,
      about: "WildBrain/Flying Bark CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix July 9, 2026. Now ~11 days of streaming as of July 19 — character names still unrevealed in wide press; no Nielsen viewership data published yet (Netflix Top 10 is the primary watch point). Fan art and reaction content continue growing on TikTok and Shorts. Produced under Mojang/Netflix license — monitor for character name reveals and first Top 10 chart appearance; if the show breaks out, original character names will be the next audience signal to track. NOT merch-eligible for Red Lava Toys." }
  ],
  ...
  headline: "WEEK OF JUL 13 — ALAN BECKER (AvM): 'Animation vs. Geometry Dash' RELEASED July 18 — reaction wave just starting Jul 19+; next Red & Blue episode teased in newsletter; 33.6M subs, ZERO mass retail = top open white-space merch opportunity. CHIP & MILO: Milo plush actively shipping at miloandchip.com (prev. 4K orders/2 wks, no big-box competition). JJ & MIKEY: TV series streaming Tubi/Roku, Bonkers Toys retail gap open until Spring 2027 + Scholastic books Jan 2027. CaseOh: 10.75M subs, 5.29% engagement, Kitty drop Jul 3, best open US creator slot. PrestonPlayz mini figures + plush NOW on Target/Walmart shelves — live competition to benchmark. SSundee + Crainer 'Crundee' series active through July. (Mojang IP: Netflix Minecraft Series ~11 days in, no character reveals or viewership data yet; Movie Summer Sale main phase through Jul 28; doorbuster deals ended Jul 14 — not merch.)"
};
