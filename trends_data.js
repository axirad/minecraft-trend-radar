...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Aphmau", type: "Creator", subs: 25.9, buzz: [8, 9, 9, 9, 10], interest: [80, 87, 89, 89, 95], rising: true,
      about: "Aphmau (Jess) is one of the biggest kid-facing Minecraft creators (~25.9M subscribers) with 29.6B+ lifetime views as of July 2026. Bonkers Toys' SDCC booth (#221) closed July 21 — the MyStreet con-exclusive window is over; nationwide retail launches August 2026, stacking on top of four concurrent MeeMeows blind-box waves (Carnival Treats, Elemental MeeMeow, Celestial Cats, MeeMeows Collectors Case) at 9+ major retailers. MyStreet: One Last Time (Season 8 finale, two-part series) is actively returning on Aphmau Diaries YouTube channel — its imminent drop is driving renewed fan engagement heading into the retail launch. August = double-stacked custom merch window: four existing MeeMeows waves on shelf simultaneously with the MyStreet line launching — year-high interest, custom merch window open NOW." },
    { name: "Maizen", type: "Creator", subs: 23, buzz: [9, 9, 9, 9, 9], interest: [78, 85, 87, 88, 90], rising: true,
      about: "Maizen (22.9M subs per Variety May 2026; 23B+ lifetime views, ranked #1 gaming channel globally) makes story-driven Minecraft skits built around its 'JJ and Mikey' characters. JJ & Mikey is now in its fourth week of streaming on Tubi, Roku, and Ryan and Friends Plus as of July 25, 2026 — actively driving new audience discovery. Scholastic books launch early 2027; Bonkers Toys plush + blind-boxes confirmed Spring 2027. The gap between now and the official retail toy launch is the near-term custom-merch window." },
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 5, 3, 3, 3], interest: [68, 59, 50, 39, 30], rising: false,
      about: "Jelly is a top kid-friendly Minecraft YouTuber (~23M subs) known for short, easy-to-watch videos. He plays challenges, mini-games and modded worlds, often with friends. Six-month slide continues through late July 2026 — no new series, hook content, or franchise announcement; interest down to 30 from a 68 peak at Jun 1, a steady-state catalog name rather than an active trend driver." },
    ...
    { name: "SSundee", type: "Creator", subs: 25.45, buzz: [8, 8, 9, 9, 9], interest: [64, 66, 72, 76, 79], rising: true,
      about: "SSundee (25.45M subs, ~4 uploads/week, 2.56% engagement) is a top US Minecraft creator known for funny commentary and pop-culture mod drops. Long-running collaboration partner Crainer (MrCrainer) officially returned in 2026 — their 'Crundee' server series launched May 17, 2026 and the Crundee Craft modpack was updated July 19, 2026 (206K+ CurseForge downloads), confirming the series is actively producing content into late July. The reunion generates sustained excitement among fans who grew up with the duo. Zero official toy line = best open US-creator custom merch slot alongside Alan Becker." },
    ...
    { name: "CaseOh", type: "Creator", subs: 10.75, buzz: [7, 8, 9, 9, 9], interest: [63, 68, 76, 82, 85], rising: true,
      about: "CaseOh has grown to ~10.75M YouTube subscribers. As of late July 2026, monthly subscriber growth is ~1.84% (rated Good) with 5.07% engagement — still strong but a slight ease from peak rates. The Kitty summer drop (launched July 3, hoodies, apparel, PC accessories at caseohgames.com) is now listed under 'Sold Out — Previous Drops'; a StarForge Systems exclusive custom PC collab accompanied the drop. No next drop date announced yet — window is open for complementary custom merch. No official toy line exists = best open US creator slot alongside Alan Becker; audience skews slightly older (teen) but brand energy bleeds into the 8–10 demo." },
    ...
    { name: "TommyInnit", type: "Creator", subs: 12, buzz: [5, 5, 5, 4, 4], interest: [49, 49, 47, 41, 34], rising: false,
    ...
    { name: "Wisp", type: "Creator", subs: null, buzz: [4, 4, 4, 4, 4], interest: [46, 44, 42, 37, 34], rising: false,
    ...
    { name: "Stampy", type: "Creator", subs: null, buzz: [4, 3, 3, 3, 3], interest: [37, 35, 33, 29, 25], rising: false,
    ...
    { name: "Craftee", type: "Creator", subs: 5.2, buzz: [null, 6, 2, 2, 2], interest: [null, 50, 35, 23, 15], rising: false,
      about: "Craftee is a purely Minecraft-focused creator (~5M subs, ~12M monthly views) who appears on every curated 'kid-safe' list — no profanity, challenge and creative gameplay targeting ages 5–10. The craftee.store plush lineup (Classic Plushie $29.99, Golden variant, Chester plushie $26.99) remains available but generating no new buzz. Subscriber growth stalled near zero through July 2026; no franchise deals, retail expansion, or new drops detected. Seven consecutive trend score drops with no catalyst in sight — firmly catalog-only territory." },

    { name: "OMZ", type: "Creator", subs: 6.06, buzz: [null, null, 7, 7, 7], interest: [null, null, 60, 68, 72], rising: true,
      about: "OMZ (Omz Crew) is an American Minecraft roleplay YouTuber (~6.06M subscribers, 1.66B total views) generating 54M+ monthly views as of July 2026, with +30K new subscribers per month. Large recurring cast: Roxy, Crystal, Lily, Kevin, Heather, Violet, Alexa, and Luke. Merch confirmed at omzcrew.com, Amazon (ASIN B0FLLH2SR9 full crew bundle), TikTok Shop, and Walmart. OMZ Squish Plushies also available alongside standard plush and mystery boxes. Active scripted drama arcs sustaining engagement through late July 2026 — adding to format-level roleplay interest. Content tone and age target (6–10) mirror Cash & Nico." },

    { name: "Yarik Paw", type: "Creator", subs: 4.6, buzz: [null, null, null, null, 7], interest: [null, null, null, null, 57], rising: true,
      about: "Yarik Paw (@YarikPawGames) is a Ukrainian creator pioneering 'cinematic Minecraft' — episodic stories with emotional arcs and cliffhangers — at ~4.6M subscribers and 2.9B lifetime views; his Shorts channel (YarikPawShorts) hit 500M views in just 75 days, confirming exceptional short-form reach. The narrative format with recurring characters maps well to the 5–10 demo (comparable to Aphmau-style story-Minecraft). No toy or licensing deal found as of July 2026: notable white space given the defined character roster, 2.9B views, and the proven appetite for story-Minecraft product." },
    ...
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9, 10, 10], interest: [70, 77, 85, 98, 99], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (~33.6M subs, approaching 34M). 'Animation vs. Geometry Dash' (released July 18, 2026) is now 8 days in as of July 26: the AvG initial spike has settled into secondary gameplay/reaction content still circulating on TikTok and Shorts. July newsletter confirmed a new AvM Minecraft episode featuring Red & Blue — NOT dropped yet as of July 26; release is increasingly imminent and will re-spike interest once live. Merch via alanbecker.shop and Youtooz (Couch Figures set, Blind Box) only — zero mass-retail presence despite 33M+ subscribers: largest under-served retail white space in creator-Minecraft merch." },
    ...
    { name: "Brainrot skits", type: "Format", subs: null, buzz: [7, 6, 2, 1, 1], interest: [63, 60, 42, 27, 16], rising: false,
    ...
    { name: "Roleplay servers", type: "Format", subs: null, buzz: [5, 5, 5, 5, 6], interest: [46, 48, 51, 57, 64], rising: true,
      about: "Minecraft roleplay (RP) servers are fictional worlds with their own economies, governments and ongoing storylines where players act out characters. They're growing fast as a social, narrative way to play. OMZ Crew's active drama storylines continue to drive format-level engagement through late July 2026 — the longest-running signal for this format to date. Popular with kids who love the 'pretend' and community side." },

    // ---- MOJANG IP — official game content (CUSTOMER AWARENESS ONLY, not merch) ----
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4, 2, 2, 1], interest: [50, 43, 28, 14, 5], rising: false,
    ...
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 9, 9, 9], interest: [null, null, 74, 89, 86], rising: true,
      about: "WildBrain/Flying Bark CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix June 24, 2026 — now 31 days of streaming as of July 25. Netflix's July 16, 2026 earnings call did not cite the series as a record-breaker; character names remain unrevealed in wide press; no Netflix Top 10 appearance confirmed to date. Fan art and reaction content continue at lower velocity. Produced under Mojang/Netflix license — monitor for character name reveals and first Top 10 chart appearance; those milestones will signal when mainstream demand peaks. NOT merch-eligible for Red Lava Toys." }
  ],
  ...
  headline: "WEEK OF JUL 20 (UPDATED JUL 26) — APHMAU: SDCC booth closed Jul 21; MyStreet finale returning on Aphmau Diaries imminently + August 2026 nationwide retail launch NOW days away — interest 95, year-high; custom merch window OPEN NOW before four MeeMeows waves on shelf stack with MyStreet launch in August. ALAN BECKER (AvM): 'Animation vs. Geometry Dash' (Jul 18) day 8, AvG wave settling — new AvM Red & Blue episode still NOT dropped as of Jul 26, release increasingly imminent; 33.6M subs, ZERO mass retail = #1 white-space merch slot. JJ & MIKEY: Week 4+ on Tubi/Roku/Ryan Friends Plus; Bonkers Spring 2027 retail gap wide open. CHIP & MILO: Milo + Chip plush shipping at miloandchip.com, DTC/Amazon only — no big-box competition. CaseOh: Jul 3 Kitty drop sold out, next drop TBA — window open. SSundee+Crainer: Crundee modpack updated Jul 19, series confirmed active. OMZ: Roleplay drama arcs sustaining format momentum (interest 72, rising). WATCH: YARIK PAW — cinematic Minecraft, 4.6M subs, 2.9B views, Shorts channel 500M views in 75 days — upgraded buzz 7, no toy deal = open white space. (Mojang IP: Netflix Series 32 days in, no Top 10 or character reveals yet — not merch; Minecraft Summer Sale ends Jul 28 — final 2 days; Movie sequel filming NZ for Jul 2027 — not merch.)"
};
