...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "Aphmau", type: "Creator", subs: 25.9, buzz: [8, 9, 9], interest: [80, 87, 89], rising: true,
      about: "Aphmau (Jess) is one of the biggest kid-facing Minecraft creators (~25.9M subscribers) with 29.6B+ lifetime views as of July 2026. Summer 2026 retail: FOUR concurrent blind-box waves — Carnival Treats 6\" Mystery Plush (ASIN B0DFMSLZ4C), Elemental MeeMeow Mystery Plush (8 elemental cats), Celestial Cats series, and the MeeMeows Collectors Case (10\" catface case, 8 mystery surprises incl. first collectable Aphmau Animated figure) — across 9+ major retailers (Amazon, Walmart, Target, Claire's, GameStop, Michaels, BoxLunch, Entertainment Earth, Smyths). MyStreet Season 8 'One Last Time' in production in 2026." },
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 5, 3], interest: [68, 59, 50], rising: false,
    ...
    { name: "SSundee", type: "Creator", subs: 25.4, buzz: [8, 8, 9], interest: [64, 66, 72], rising: true,
      about: "SSundee (25.4M confirmed subs) is a top US Minecraft creator known for funny commentary and pop-culture mod drops. His long-running collaboration partner Crainer (MrCrainer) officially returned in 2026 after a multi-year hiatus — their reunion content is generating strong excitement among fans who grew up watching their SkyFactory series. Zero official toy line = best open US-creator custom merch slot alongside Alan Becker; upload frequency and engagement remain excellent." },
    { name: "LankyBox", type: "Creator", subs: 42, buzz: [7, 5, 0], interest: [65, 55, 20], rising: false,
      about: "LankyBox is a 42M-sub duo known for 'brainrot'-style Minecraft skits. Confirmed quit in mid-2026 — no uploads since ~April 2026; fan analysis videos 'I Figured Out Why LankyBox Quit!' and 'The End of LankyBox..' are the dominant narrative. The Adam McArthur / Justin Kroma partnership-split story is entrenched on TikTok. TikTok Shop (748K+ items sold historically) and retail (Target, GameStop, Amazon) remain live passively on existing SKUs. Channel is finished — do not invest in LankyBox-adjacent product for 2026-2027." },
    { name: "CaseOh", type: "Creator", subs: 10.65, buzz: [7, 8, 9], interest: [63, 68, 76], rising: true,
      about: "CaseOh has grown to ~10.65M YouTube subscribers and 8.54M Twitch followers. As of July 11, 2026, he is in the top 1% by weekly growth (+100K in 7 days, +300K in 30 days); engagement rate jumped to 4.18% — excellent for a channel this size. His Casemart merchandise line is a major revenue stream (~$80K–$150K/month). Known for 'Minecraft BUT…' challenge and reaction content. No official toy line exists = best open custom merch slot with CaseOh's accelerating trajectory; audience skews slightly older (teen) but brand energy bleeds into the 8–10 demo." },
    ...
    { name: "Wisp", type: "Creator", subs: null, buzz: [4, 4, 4], interest: [46, 44, 42], rising: false,
    ...
    { name: "Craftee", type: "Creator", subs: 5.2, buzz: [null, 6, 2], interest: [null, 50, 35], rising: false,
    ...
    { name: "OMZ", type: "Creator", subs: 6.1, buzz: [null, null, 7], interest: [null, null, 60], rising: true,
    ...
    { name: "JJ & Mikey", type: "Character/Mob", subs: null, buzz: [10, 10, 10], interest: [96, 97, 98], rising: true,
      about: "JJ and Mikey are the lead characters of Maizen's animated Minecraft skits — the JJ & Mikey TV series is streaming NOW on Tubi, Roku, and Ryan and Friends Plus, actively driving new audience discovery as of July 10, 2026. The official Bonkers Toys plush + blind-boxes don't hit major retailers until Spring 2027 — the gap is the near-term custom-merch opportunity. Maizen universe supporting characters 'Carrie' and 'Banana Kid' are now being requested by name in Etsy buyer reviews (June 2026) with zero official product — open custom design slots alongside JJ & Mikey. A single 'Johnny Minecraft Plush' listing previously crossed 171,600 units sold on TikTok Shop. Confirmed #1 top sellers at Red Lava Toys shows." },
    { name: "Nico & Cash", type: "Character/Mob", subs: null, buzz: [10, 9, 9], interest: [90, 86, 87], rising: true,
      about: "Nico and Cash are a paired-character Minecraft animation duo — Cash's channel at ~11M subscribers, Nico at ~4.9M and climbing. Official plush line at cashandnico.com includes Nico Superhero, Cash Superhero, Shady, Toast Miner, and Meebo plushies, plus a limited Cash+Nico+Meebo bundle; Amazon shows 2,000+ units sold per month in Kids' Plush Toy Pillows — a meaningful and undertracked commercial signal. A 'Nico: The Movie' theatrical project circulates in fan wikis but has not been confirmed by any trade publication (Variety/Deadline) as of July 2026 — treat as audience excitement until a signed deal is announced." },
    { name: "Chip & Milo", type: "Character/Mob", subs: 4.1, buzz: [9, 8, 9], interest: [85, 83, 90], rising: true,
      about: "Milo and Chip are an animated-Minecraft duo from EYstreem's Spawnpoint Media (4.1M subs, 231M views/month as of June/July 2026 — 4.52% monthly sub growth, 280K new subs/30 days). The Milo collectible plush sold out in 2 weeks (4,000 orders, zero paid marketing) and is back in stock at miloandchip.com; no Chip-specific plush confirmed yet — supply gap. The Elemental Milo & Chip skin pack launched May 2026 (4.8/5 stars); T-shirts, stickers, water bottles available DTC. Spawnpoint Media is a $5M Spotter-backed studio with 100+ staff. Retail footprint remains DTC/Amazon only — no big-box expansion yet. Milo (age 6) and Chip (age 10) bracket the 5–10 demo perfectly; this is the fastest-growing kids Minecraft IP with proven plush demand and no mass-retail competition." },
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9], interest: [70, 77, 85], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). 'The Machine — Animator vs. Animation 13' (Season 3, Episode 5) released May 30, 2026 — reaction content and breakdowns flooded YouTube; Alan Becker posted it in parts on TikTok (@alan.becker). A separate AvGDash (Animation vs. Geometry Dash) episode remains pending per June 2026 newsletter ('Green TBA'). Youtooz character 'Mitsi' now has her own 9\" plush listing. Merch via alanbecker.shop and Youtooz only — zero mass-retail presence despite 33M+ subscribers: the biggest under-served retail white space in creator-Minecraft merch." },
    ...
    { name: "Brainrot skits", type: "Format", subs: null, buzz: [7, 6, 2], interest: [63, 60, 42], rising: false,
      about: "'Brainrot' skits are chaotic, sensory-overload short videos that use Minecraft skins to act out absurd stories. LankyBox's TikTok Shop confirmed 748K+ items sold historically — this audience converts directly to buyers at high volume. LankyBox is now confirmed quit (no uploads since April, fan analysis videos circulating) and the format's primary signal driver is offline with no returning creator. Fast, loud and meme-driven — format can reactivate under a new creator but no current replacement has emerged as of July 12, 2026." },
    { name: "Roleplay servers", type: "Format", subs: null, buzz: [5, 5, 5], interest: [46, 48, 51], rising: true,
    ...
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4, 2], interest: [50, 43, 28], rising: false,
    ...
    { name: "A Minecraft Movie", type: "Format", ip: "mojang", subs: null, buzz: [6, 7, 9], interest: [62, 68, 75], rising: true,
    ...
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 9], interest: [null, null, 74], rising: true,
      about: "WildBrain/Flying Bark CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix July 9, 2026 — 3 days live as of July 12. All-new original characters in a 3D action-comedy format; specific character names have not yet been widely published. Fan art and reaction content building on TikTok and Shorts in real time. No viewership data yet — Nielsen weekly numbers expected within 7–14 days. Produced under Mojang/Netflix license — monitor character name reveals this week; if the show breaks out, original character merch will be the next wave. NOT merch-eligible for Red Lava Toys." }
  ],

  // Merch-eligible names ONLY (never Mojang IP).
  movers: {
    up:   ["Chip & Milo", "PrestonPlayz", "JJ & Mikey"],
    down: ["LankyBox", "Jelly", "Brainrot skits", "Craftee"],
    new:  []
  },

  headline: "WEEK OF JUL 6 (REFINED Jul 12) — CHIP & MILO BREAKOUT: 231M views/month on 4.1M-sub channel, Milo plush sold out 4K orders in 2 weeks zero paid marketing = highest-signal rising IP in the radar. JJ & Mikey Tubi/Roku streaming active — Bonkers gap until Spring 2027 wide open. PrestonPlayz: Series 1 mini figures + Mystery Merch Box confirmed on shelf July 2026 — benchmark now. Alan Becker: 'The Machine' AvA13 released May 30, 33M+ subs zero mass retail. LankyBox: quit CONFIRMED — investment paused. (Mojang IP: Netflix Series premiered Jul 9 — 3 days live, character names watch this week; Summer Sale through Jul 28; Movie Squared filming NZ — not merch.)"
};
