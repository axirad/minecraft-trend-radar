...
window.TREND_DATA = {
  ...
  entities: [
    ...
    { name: "LankyBox", type: "Creator", subs: 42, buzz: [7, 5, 1], interest: [65, 55, 28], rising: false,
      about: "LankyBox is a 42M-sub duo known for 'brainrot'-style Minecraft skits. 3+ months into a posting hiatus (no uploads since ~April 2026) with zero return signal as of July 11, 2026; the 'The End of LankyBox' and 'Did LankyBox Finally Quit?' YouTube reaction videos are now circulating, moving the narrative from 'hiatus' to 'channel ending.' Fan speculation about an Adam McArthur / Justin Kroma partnership split is actively trending on TikTok. TikTok Shop (748K+ items sold) and retail (Target, GameStop, Amazon) remain live passively. Do not re-engage until posting resumes and sustains." },
    ...
    { name: "PrestonPlayz", type: "Creator", subs: null, buzz: [7, 7, 8], interest: [62, 63, 69], rising: true,
      about: "PrestonPlayz's Bonkers Toys line is expanding at retail: Target (March 2026) and Amazon (April 2026) carry the Mini Mystery Plush and Pleb Slayer light-up sword (NAPPA Award winner). Mini figures and additional plush are actively hitting retail shelves in July 2026 per Bonkers Toys rollout, broadening the footprint. Family of channels totals 66M combined subscribers and 22B views. Rising trajectory as new July SKUs widen the licensed line's shelf presence." },
    ...
    { name: "OMZ", type: "Creator", subs: 6.1, buzz: [null, null, 6], interest: [null, null, 56], rising: true,
      about: "OMZ (Omz Crew) is an American Minecraft roleplay YouTuber (~6.1M subscribers) with a large recurring cast — Roxy, Crystal, Lily, Kevin, Heather, Violet, Alexa, and Luke. Merch confirmed at omzcrew.com, Amazon (ASIN B0FLLH2SR9 full crew bundle), TikTok Shop, and Walmart — rapid retail expansion for a creator at this sub count. OMZ Squish Plushies (a squishy sensory format) also available alongside standard plush and mystery boxes. A new cast member is coming ('The NEW Omz Member...' YouTube video, July 2026) — new character = open custom design slot. Content tone and age target (6–10) mirror Cash & Nico." },
    ...
    { name: "Chip & Milo", type: "Character/Mob", subs: 4.1, buzz: [9, 8, 8], interest: [85, 83, 83], rising: true,
      about: "Milo and Chip are an animated-Minecraft duo from EYstreem's Spawnpoint Media (4.1M subs on the animation channel). The Milo collectible plush — which sold out in 2 weeks (4,000 orders, zero paid marketing) — is back in stock at miloandchip.com as of July 2026; the Chip-specific plush has a supply gap (possible waitlist or upcoming restock). The Elemental Milo & Chip skin pack launched May 2026; T-shirts, stickers, and water bottles also available. Retail footprint remains DTC/Amazon only with no big-box expansion confirmed yet; niche but loyal following." },
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9], interest: [70, 77, 85], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). AvGDash (Animation vs. Geometry Dash) has NOT dropped as of July 11 — announced in the June 2026 newsletter as 'Green TBA'; the prequel released May 29 and the full episode remains the single highest-anticipation pending drop in the creator-Minecraft calendar. New Youtooz character 'Mitsi' now has her own 9\" plush listing. Merch via alanbecker.shop and Youtooz only — zero mass-retail presence despite 33M+ subscribers: the biggest under-served retail white space in creator-Minecraft merch." },
    ...
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 8], interest: [null, null, 68], rising: true,
      about: "WildBrain CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix June 24, 2026 — all-new original characters in a 3D action-comedy format. Now 2+ weeks live; reaction content and fan art are actively building on TikTok and Shorts as the show finds its audience. Character names remain publicly unnamed as of July 11. Produced under Mojang/Netflix license — worth listening for which characters kids mention at shows, but NOT merch-eligible for Red Lava Toys." }
  ],

  // Merch-eligible names ONLY (never Mojang IP).
  movers: {
    up:   ["SSundee", "Alan Becker (AvM)", "JJ & Mikey", "PrestonPlayz"],
    down: ["LankyBox", "Jelly", "Brainrot skits", "Craftee"],
    new:  []
  },

  headline: "WEEK OF JUL 6 (REFINED Jul 11) — SSundee/Crainer reunion pushing buzz to 9: 25.4M subs, zero official toy line = best open US-creator custom slot alongside Alan Becker (AvGDash still TBA, 33M+ subs, zero mass retail). JJ & Mikey Tubi/Roku/Ryan+ streaming driving discovery — Bonkers gap until Spring 2027; 'Carrie' + 'Banana Kid' = zero official plush. PrestonPlayz: mini figures now hitting shelves in July. LankyBox: 'The End of LankyBox' content circulating — split narrative firming, interest in freefall. (Mojang/WB IP: Netflix Series 2+ wks live, characters still unnamed; Summer Sale through Jul 28; Movie Squared filming NZ — not merch.)"
};
