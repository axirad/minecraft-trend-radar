...
window.TREND_DATA = {
  updated: "2026-07-16",
  weeks: ["Jun 1", "Jun 29", "Jul 6", "Jul 13"],    // week-start labels, oldest -> newest

  entities: [
    // ---- CREATORS (the "make my skin look like them" names) ----
    { name: "Aphmau", type: "Creator", subs: 25.9, buzz: [8, 9, 9, 9], interest: [80, 87, 89, 89], rising: true,
    ...
    { name: "Maizen", type: "Creator", subs: 23, buzz: [9, 9, 9, 9], interest: [78, 85, 87, 88], rising: true,
      about: "Maizen (22.9M subs per Variety May 2026; 23B+ lifetime views, ranked #1 gaming channel globally) makes story-driven Minecraft skits built around its 'JJ and Mikey' characters. JJ & Mikey is now in its second week of streaming on Tubi, Roku, and Ryan and Friends Plus as of July 15, 2026 — actively driving new audience discovery. Scholastic books launch early 2027; Bonkers Toys plush + blind-boxes confirmed Spring 2027. The gap between now and the official retail toy launch is the near-term custom-merch window." },
    { name: "Mikecrack", type: "Creator", subs: 58, buzz: [7, 7, 7, 7], interest: [72, 71, 71, 71], rising: false,
    ...
    { name: "Jelly", type: "Creator", subs: 23, buzz: [7, 5, 3, 3], interest: [68, 59, 50, 39], rising: false,
    ...
    { name: "MrBeast Gaming", type: "Creator", subs: 42, buzz: [7, 7, 7, 7], interest: [73, 71, 71, 71], rising: false,
    ...
    { name: "SSundee", type: "Creator", subs: 25.4, buzz: [8, 8, 9, 9], interest: [64, 66, 72, 75], rising: true,
      about: "SSundee (25.4M confirmed subs) is a top US Minecraft creator known for funny commentary and pop-culture mod drops. His iBlocky Minecraft server entered final days in late 2025 amid pay-to-win controversy — SSundee responded publicly and made changes, but community backlash generated significant drama content from third-party creators. Meanwhile, his long-running collaboration partner Crainer (MrCrainer) officially returned in 2026 after a multi-year hiatus — their SSundee + Crainer server series is actively producing content as of July 2026, generating sustained excitement among fans. Zero official toy line = best open US-creator custom merch slot alongside Alan Becker; upload frequency and engagement remain solid." },
    { name: "LankyBox", type: "Creator", subs: 42, buzz: [7, 5, 0, 0], interest: [65, 55, 20, 9], rising: false,
      about: "LankyBox is a 42M-sub duo known for 'brainrot'-style Minecraft skits. Confirmed quit in mid-2026 — no uploads since ~April 2026 (17+ weeks); fan analysis videos 'I Figured Out Why LankyBox Quit!' and 'The End of LankyBox..' are the dominant narrative. The Adam McArthur / Justin Kroma partnership-split story is entrenched on TikTok. TikTok Shop (748K+ items sold historically) and retail (Target, GameStop, Amazon) remain live passively on existing SKUs. Channel is finished — do not invest in LankyBox-adjacent product for 2026-2027." },
    { name: "CaseOh", type: "Creator", subs: 10.65, buzz: [7, 8, 9, 9], interest: [63, 68, 76, 81], rising: true,
      about: "CaseOh has grown to ~10.65M YouTube subscribers and 8.54M Twitch followers. As of the week of July 13, 2026, he is in the top 1% by weekly growth (+100K in 7 days, +300K in 30 days, 81.8M views in 30 days); engagement rate of 4.18% is excellent for a channel this size. His Casemart merchandise line is a major revenue stream (~$80K–$150K/month). Known for 'Minecraft BUT…' challenge and reaction content. No official toy line exists = best open custom merch slot with CaseOh's accelerating trajectory; audience skews slightly older (teen) but brand energy bleeds into the 8–10 demo." },
    { name: "EYstreem", type: "Creator", subs: 13.6, buzz: [8, 8, 8, 8], interest: [74, 76, 76, 77], rising: true,
    ...
    { name: "DanTDM", type: "Creator", subs: 29, buzz: [6, 6, 6, 6], interest: [58, 58, 58, 57], rising: false,
    ...
    { name: "PrestonPlayz", type: "Creator", subs: null, buzz: [7, 7, 9, 9], interest: [62, 63, 72, 74], rising: true,
    ...
    { name: "Dream", type: "Creator", subs: 31.5, buzz: [5, 5, 5, 5], interest: [53, 52, 50, 47], rising: false,
    ...
    { name: "Unspeakable", type: "Creator", subs: null, buzz: [5, 5, 5, 5], interest: [51, 50, 50, 50], rising: false,
    ...
    { name: "TommyInnit", type: "Creator", subs: 12, buzz: [5, 5, 5, 4], interest: [49, 49, 47, 41], rising: false,
      about: "TommyInnit is a hugely popular British creator (~12M subs) who rose through Minecraft SMP servers and streams. He shifted to selective content in 2026 ('100 Questions with Tom Simons' interview series, first MC Championship appearance in ~2 years). He skews slightly older-kid/teen. Gradual audience drift continues." },
    { name: "Wisp", type: "Creator", subs: null, buzz: [4, 4, 4, 4], interest: [46, 44, 42, 37], rising: false,
    ...
    { name: "Stampy", type: "Creator", subs: null, buzz: [4, 3, 3, 3], interest: [37, 35, 33, 29], rising: false,
    ...
    { name: "Craftee", type: "Creator", subs: 5.2, buzz: [null, 6, 2, 2], interest: [null, 50, 35, 23], rising: false,
      about: "Craftee is a purely Minecraft-focused creator (~5M subs, ~12M monthly views) who appears on every curated 'kid-safe' list — no profanity, challenge and creative gameplay targeting ages 5–10. The craftee.store plush lineup (Classic Plushie $29.99, Golden variant, Chester plushie $26.99) remains available but generating no new buzz. Subscriber growth stalled near zero through July 2026; no franchise deals, retail expansion, or new drops detected. Firmly in catalog-only territory — five consecutive trend score drops with no catalyst in sight." },

    { name: "OMZ", type: "Creator", subs: 6.1, buzz: [null, null, 7, 7], interest: [null, null, 60, 66], rising: true,
      about: "OMZ (Omz Crew) is an American Minecraft roleplay YouTuber (~6.1M subscribers) generating 32M+ monthly views as of July 2026, with 30K–80K new subscribers per month. Large recurring cast: Roxy, Crystal, Lily, Kevin, Heather, Violet, Alexa, and Luke. Merch confirmed at omzcrew.com, Amazon (ASIN B0FLLH2SR9 full crew bundle), TikTok Shop, and Walmart — rapid retail expansion for a creator at this sub count. OMZ Squish Plushies also available alongside standard plush and mystery boxes. Active drama storylines (Omz & Crystal breakup, July 2026) driving roleplay-format engagement and search interest. Content tone and age target (6–10) mirror Cash & Nico." },
    ...
    { name: "Chip & Milo", type: "Character/Mob", subs: 4.1, buzz: [9, 8, 9, 9], interest: [85, 83, 90, 93], rising: true,
      about: "Milo and Chip are an animated-Minecraft duo from EYstreem's Spawnpoint Media (4.1M subs, 231M views/month as of June/July 2026 — 4.52% monthly sub growth, 280K new subs/30 days). The Milo plush is back in stock and actively shipping at miloandchip.com as of July 2026 — it previously sold out 4,000 orders in 2 weeks with zero paid marketing; Chip plushie also available. The Elemental Milo & Chip skin pack launched May 2026 (4.8/5 stars). Retail footprint remains DTC/Amazon only — no big-box expansion confirmed yet. Milo (age 6) and Chip (age 10) bracket the 5–10 demo perfectly; fastest-growing kids Minecraft IP with proven plush demand and no mass-retail competition." },
    { name: "Alan Becker (AvM)", type: "Character/Mob", subs: 33.6, buzz: [8, 8, 9, 10], interest: [70, 77, 85, 92], rising: true,
      about: "Alan Becker's color-coded stick figures — The Second Coming, King Orange, Yellow, Green, Blue, and Red — star in 'Animation vs. Minecraft' (33.6M subs, 9.6B+ views). The July 2026 newsletter confirmed the 'Animation vs. Geometry Dash' crossover episode is expected this month; animator Lunsar has already uploaded the custom Geometry Dash level 'Wicked VIP' tied to the video — the episode is days away as of July 16. A separate sneak peek of the next AvM Minecraft episode (Red and Blue) is also in queue. 'The Machine — Animator vs. Animation 13' released May 30 and still pulling reaction content 7 weeks later. Merch via alanbecker.shop and Youtooz only — zero mass-retail presence despite 33M+ subscribers: the largest under-served retail white space in creator-Minecraft merch right now." },

    // ---- FORMATS / TOPICS (what kind of videos they're glued to) ----
    { name: "'Minecraft BUT…'", type: "Format", subs: null, buzz: [7, 7, 7, 7], interest: [61, 62, 62, 62], rising: false,
    ...
    { name: "Brainrot skits", type: "Format", subs: null, buzz: [7, 6, 2, 1], interest: [63, 60, 42, 27], rising: false,
      about: "'Brainrot' skits are chaotic, sensory-overload short videos that use Minecraft skins to act out absurd stories. LankyBox's TikTok Shop confirmed 748K+ items sold historically — this audience converts directly to buyers at high volume. LankyBox is now confirmed quit (17+ weeks, no uploads since ~April 2026) and the format's primary signal driver is offline with no returning creator and no replacement emerging as of July 15, 2026. Format buzz at lowest point tracked." },
    { name: "Roleplay servers", type: "Format", subs: null, buzz: [5, 5, 5, 5], interest: [46, 48, 51, 57], rising: true,
      about: "Minecraft roleplay (RP) servers are fictional worlds with their own economies, governments and ongoing storylines where players act out characters. They're growing fast as a social, narrative way to play. OMZ Crew's active drama storylines (Omz & Crystal breakup, July 2026) are adding to format-level engagement. Popular with kids who love the 'pretend' and community side." },

    // ---- MOJANG IP — official game content (CUSTOMER AWARENESS ONLY, not merch) ----
    { name: "Baby mobs (Tiny Takeover)", type: "Character/Mob", ip: "mojang", subs: null, buzz: [4, 4, 2, 2], interest: [50, 43, 28, 14], rising: false,
    ...
    { name: "Sulfur cube", type: "Character/Mob", ip: "mojang", subs: null, buzz: [6, 6, 6, 6], interest: [54, 55, 55, 56], rising: true,
    ...
    { name: "A Minecraft Movie", type: "Format", ip: "mojang", subs: null, buzz: [6, 7, 9, 9], interest: [62, 68, 75, 78], rising: true,
      about: "The live-action/animated Warner Bros. film (April 2025) continues to drive streaming discovery; the Minecraft Summer Sale (June 30–July 28, 2026) adds platform-level discoverability through end of July. Sequel 'A Minecraft Movie Squared' (July 23, 2027) is filming in New Zealand — confirmed cast includes Momoa, Black, Brooks, Coolidge returning, plus Kirsten Dunst as Alex. Matt Berry is confirmed for a mystery role; press and fans widely speculate he plays Herobrine (handed a Steve-like vest at Minecraft Live), but the studio has not officially confirmed this. Mojang/WB IP — strong customer-conversation context, not merch-eligible for Red Lava Toys." },
    { name: "Netflix Minecraft Series", type: "Format", ip: "mojang", subs: null, buzz: [null, null, 9, 9], interest: [null, null, 74, 86], rising: true,
      about: "WildBrain/Flying Bark CG-animated series (head writer: A.C. Bradley of Marvel's What If...?) premiered on Netflix July 9, 2026. Now day 8 of streaming (week 2) as of July 16 — character names still unrevealed in wide press; fan art and reaction content continue building on TikTok and Shorts but specific character names not yet entering measurable search volume. Nielsen first-week viewership numbers expected imminently. Produced under Mojang/Netflix license — monitor for character name reveals; if the show breaks out, original character names will be the next audience signal. NOT merch-eligible for Red Lava Toys." }
  ],

  // Merch-eligible names ONLY (never Mojang IP).
  movers: {
    up:   ["Alan Becker (AvM)", "CaseOh", "Chip & Milo"],
    down: ["Jelly", "Brainrot skits", "Craftee"],
    new:  []
  },

  headline: "WEEK OF JUL 13 — ALAN BECKER (AvM): buzz 10 and climbing — AvM vs. Geometry Dash episode DAYS AWAY (animator's custom GD level 'Wicked VIP' already uploaded); next AvM Minecraft ep (Red & Blue sneak peek) also queued; 33.6M subs, zero mass retail = largest open white space on the board. CHIP & MILO: Milo plush actively shipping at miloandchip.com (4K orders/2 weeks last time, no big-box competition). CaseOh: top 1% YouTube growth (10.65M subs, 81.8M views/30 days), best open US creator slot. JJ & MIKEY: Tubi/Roku streaming week 2, Bonkers Toys gap open until Spring 2027. PrestonPlayz July mini figures + plush now on Target/Amazon — benchmark competition on shelf. (Mojang IP: Netflix Minecraft Series day 8 of streaming, character names still unrevealed — watch for first Nielsen numbers; Movie Summer Sale through Jul 28 — not merch.)"
};
