...
window.TREND_DATA = {
  ...
  headline: "WEEK OF JUL 20 (UPDATED JUL 25) — APHMAU: SDCC booth closed Jul 21; MyStreet finale returning on Aphmau Diaries imminently + August 2026 nationwide retail launch — interest 95, year-high; custom merch window OPEN NOW before four MeeMeows waves on shelf stack with MyStreet launch in August. ALAN BECKER (AvM): 'Animation vs. Geometry Dash' (Jul 18) day 7, AvG wave settling — new AvM Red & Blue episode still NOT dropped as of Jul 25, release increasingly imminent; 33.6M subs, ZERO mass retail = #1 white-space merch slot. JJ & MIKEY: Week 4+ on Tubi/Roku/Ryan Friends Plus; Bonkers Spring 2027 retail gap wide open. CHIP & MILO: Milo + Chip plush shipping at miloandchip.com, DTC/Amazon only — no big-box competition. CaseOh: Jul 3 Kitty drop sold out, next drop TBA — window open. SSundee+Crainer: Crundee modpack updated Jul 19, series confirmed active. OMZ: Roleplay drama arcs sustaining format momentum (interest 72, rising). WATCH: YARIK PAW — cinematic Minecraft, 4.6M subs, 2.9B views, no toy deal. (Mojang IP: Netflix Series 31 days, no Top 10 or character reveals yet — not merch; Minecraft Summer Sale ends Jul 28 — final 3 days; Movie sequel filming NZ for Jul 2027 — not merch.)"
};
